            ...
            series: [
                {
                    ...
                    data: convertData([
                        { name: "方特", value: 50, itemStyle: {color: '#ff0000'} },
                        { name: "北辰郊野公园", value: 50 },
                        { name: "五大道", value: 50 },
                        { name: "人民公园", value: 50 },
                        { name: "津门故里", value: 50, itemStyle: {color: '#ff0000'}},
                        ...
                        { name: "黄崖关长城", value: 45},
                        { name: "天津鼓楼",value: 48},
                        { name: "天津泰达航母主题公园",value: 43},
                        { name: "太平寨",value: 44},
                        { name: "庆王府旧址", value: 42},
                        { name: "天津利顺德博物馆",value: 41},
                        { name: "天津北疆博物馆", value: 38},
                        { name: "天津海昌极地海洋世界",value: 42},
                        { name: "黑峪神秘谷", value: 41},
                        { name: "天津大沽口炮台遗址", value: 35},
                        { name: "菜芽庄路", value: 37},
                        { name: "青龙湾固沙林自然保护区", value: 38},
                        { name: "潮白河国家湿地公园", value: 40},
                        { name: "七里海国家湿地公园", value: 35},
                        { name: "古海岸与湿地国家级自然保护区", value: 42},
                        { name: "团泊湖", value: 22},
                        { name: "萨马兰奇纪念馆", value: 37},
